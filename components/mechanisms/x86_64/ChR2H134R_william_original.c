...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 ChR2_original /home/gjgpb9/feng_opto_stim/python_bmtk/components/mechanisms/modfiles/ChR2H134R_william_original.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gjgpb9/feng_opto_stim/python_bmtk/components/mechanisms/modfiles/ChR2H134R_william_original.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "-----------------------------------------------------------------------------\n"
  "ChR2H134R.mod\n"
