...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 Gap /home/gjgpb9/feng_opto_stim/python_bmtk/components/mechanisms/modfiles/gap.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gjgpb9/feng_opto_stim/python_bmtk/components/mechanisms/modfiles/gap.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "  POINT_PROCESS Gap\n"
  "  ELECTRODE_CURRENT i\n"
